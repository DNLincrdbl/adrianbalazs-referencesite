      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            ...
            <span className="text-red-500">seit 1990</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a
              href="#references"
              className="inline-flex items-center px-8 py-4 bg-white/10 backdrop-blur-sm text-white rounded-lg font-semibold hover:bg-white/20 transition-all group"
            >
              Referenzen Ansehen
              <svg className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
          {[
            ...
            <div
              key={index}
              className="flex items-center space-x-4 bg-white/10 backdrop-blur-sm p-6 rounded-xl hover:bg-white/20 transition-all"
            >
