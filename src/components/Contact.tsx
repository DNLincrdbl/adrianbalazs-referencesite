            ...
            <div className="bg-white/70 backdrop-blur-lg rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 transform hover:-translate-y-1 hover:shadow-[0_20px_40px_rgb(0,0,0,0.08)] transition-all duration-300">
              <div className="space-y-8">
                ...
                <div className="group flex items-center">
                  ...
                  <a href="tel:+49015145797251" className="text-lg text-stone-900 hover:text-red-900 transition-colors">
                    +49 (0) 151 45797251
                  </a>
                </div>
                ...
                <div className="group flex items-center">
                  ...
                  <a href="https://wa.me/49015145797251" target="_blank" rel="noopener noreferrer" className="text-lg text-stone-900 hover:text-green-600 transition-colors">
