  ...
  return (
    <section id="contact" className="py-32 bg-gradient-to-b from-stone-100 via-white to-stone-50 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative flex flex-col items-center">
        ...
        {/* Contact Card */}
        <div className="w-full bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl p-10 flex flex-col gap-8 items-center mb-12">
        ...
        <div className="w-full max-w-3xl mx-auto rounded-3xl overflow-hidden shadow-xl border border-stone-200">
          <iframe
